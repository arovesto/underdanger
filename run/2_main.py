...
from code.io.ui import get_stat_line
from code.util.acii_arts import skull

from code.io.key_input import key_pressed
...
def get_action(player):
    ...
    # action = input()
    action = key_pressed(player.possible_keys)
