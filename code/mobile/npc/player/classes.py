from code.equipment.weapons import player_bow, player_knife, metal_bow, player_small_knife, whip
from code.equipment.magic import small_ring, magic_bomb
from code.mobile.npc.player.player import Player
from code.equipment.armor import helmet, pants, chain_mail, tunic, round_shield
from code.equipment.items import rest_potion, normal_heal_potion, scroll_of_sleeppy
...
class Scout(Player):
    ...
    def start_equip(self):
        ...
        self.inventory += [whip(), rest_potion(), rest_potion(), rest_potion(), normal_heal_potion(),
                           player_small_knife()]
        return self
