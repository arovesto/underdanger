...
from code.equipment.items import small_heal_potion, normal_heal_potion
from code.equipment.armor import metal_mail, shoes, rogue_helmet, aluminium_mail, stealth_cloak
from code.equipment.weapons import metal_bow, metal_knife, better_archer_bow, spear
from code.equipment.items import standard_speed_potion, big_heal_potion, super_armor
