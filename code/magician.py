...
from items import small_heal_potion, normal_heal_potion, big_heal_potion, big_speed_potion, new_map, undying, \
    scroll_of_blindness, scroll_of_sleeppy
from armor import magic_tunic
...
class Magician(Merchant):
    ...
    def start_equip(self):
        ...
        self.store = self.store_dict([(8, small_heal_potion()), (12, normal_heal_potion()), (16, big_heal_potion()),
                                      (60, big_speed_potion()), (300, new_map()), (100, undying()), (200, scroll_of_blindness()),
    ...
    def mech(self):
        ...
        where_to_go = next((d for d in self.direction_preference if self.world.can_move(self, d.go(self.position))), None)
