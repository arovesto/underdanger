...
from res import proper_magicians, proper_stealth
...
def stealth_cloak(): return StealthCloak(4, ['trunk'], "плащ невидимости", description="Добавляет владельцу маскировки. Отлично подойдет лучнику")
