...
bindings = {
    ...
    'z': ['attack', [{'type': 'use_main_weapon'}, {'type': 'key', 'allowed': ['up', 'left', 'right', 'down'],
                                                   'descr': 'В какую сторону ты хочешь атаковать?'}]],
    'x': ['attack', [{'type': 'use_second_weapon'}, {'type': 'key', 'allowed': ['up', 'left', 'right', 'down'],
                                                     'descr': 'В какую сторону ты хочешь атаковать?'}]],
    ...
    'd': ['share', [{'type': 'share'}, {'type': 'word', 'descr': 'Какому игроку вы хотите что-то отдать?'},
                    {'type': 'word', 'descr': 'Что ты бы хотел передать?'}]]
}
