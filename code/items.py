from geometry import sub, manhattan
from direction import where_to_go
from magic import small_ring, blindness, sleeppy
from res import proper_magicians, proper_warrior
from armor import heavy_armor
