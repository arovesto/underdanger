from src.equipment.weapons import player_bow, player_knife, metal_bow, player_small_knife, whip
from src.equipment.magic import small_ring, magic_bomb
from src.mobile.npc.player.player import Player
from src.equipment.armor import helmet, pants, chain_mail, tunic, round_shield
from src.equipment.items import rest_potion, normal_heal_potion, scroll_of_sleeppy
