...
from src.equipment.items import small_heal_potion, normal_heal_potion, big_heal_potion, big_speed_potion, new_map, \
    undying, \
    scroll_of_blindness, scroll_of_sleeppy
from src.equipment.armor import magic_tunic
