...
from src.geometry.direction import DIRS, anti_dir
from src.mobile.npc.npc import Npc
from src.equipment.weapons import archer_bow, better_archer_bow
from src.equipment.items import small_heal_potion, glasses, money_bag, bag, big_heal_potion
